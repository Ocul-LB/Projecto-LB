...
### Primera parte (Preparación y concientización ) <div id="Parte1"/>
...
### Segunda parte (El universo y la Mente) <div id="Parte2"/>
Los invito a tomar una noción básica de las leyes herméticas (leyes casi no debatibles ante la física moderna, salvo algunas como el karma o dharma)
[(Vídeo 3)Leyes Metafisicas](https://www.youtube.com/watch?v=q58CDOw2jnY)
...
<hr/> 
### Tercera Parte (Abriendo las alas) <div id="Parte3"/>
...
### Cuarta Parte (El principio el despertar) <div id="Parte4"/>
...
**Vídeos De interés** (No son necesarios, solo por gusto) <br/> <div id="Interes"/>
